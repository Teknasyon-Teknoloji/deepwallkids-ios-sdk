Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://github.com/Teknasyon-Teknoloji/deepwallkids-ios-sdk.git', :tag => s.version }
  ...
  s.vendored_frameworks = 'Frameworks/Dependencies/react_native_video.framework','Frameworks/DeepWallKids.xcframework'
end
